...
rm(list = ls())
# make sure to set the correct working direcory
setwd("C://Users//andre//Desktop//Univ stuff//Year 2//Master Project//Cheryl-Puzzle")
# Load data:
...
res.kruskal.level <- kruskal.test(logTime ~ Level, data = dat_ans_eight_trials)
res.kruskal.level

dunnTest(logTime ~ Level, data=dat_ans_eight_trials)
```
