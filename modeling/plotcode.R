...
tom_rfxbms <- c(0.1974620263050989, 0.08671597696194747, 0.2975927381062703, 0.3292807463919786, 0.08894851223470487)
fig_4_name <- "plots/propFit_test.png"
fig_5_name <- "plots/distribFit_test.png"

names = c("Epistemic","Cut-1 rl","Cut-1 lr", "Cut-2", "Random") #Model names
